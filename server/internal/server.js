    ...
    wss.on('connection', async function connection(ws) {
       ws.on('message', async function incoming(message) {
            ...
            if(msg.act == "fetch"){
                ...
                await dbman.insert(msg.query.table,msg.query.data).then(function(data){
                    console.log(data)
                    ws.send(JSON.stringify(data));
                })
            }else if(msg.act == "update"){
                await dbman.update(msg.query.row,msg.query.table,msg.query.data).then(function(data){
                    console.log(data)
                    ws.send(JSON.stringify(data));
                })
            }
